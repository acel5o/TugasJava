...
public class MahasiswaServiceImpl implements MahasiswaService{
    ...
    public List<Details> findAllDetail() {
        return jdbc.query(
                "select * from detail",
                (rs, rowNum) ->
                        new Details(
    ...
    @Override
    public List<Details> findByIdDetail(Long idmhs) {
        return jdbc.query(
    ...
    @Override
    public int saveDetail(Details detail,Long idmhs) {
        return jdbc.update(
    ...
    @Override
    public int updateDetail(Details detail) {
        return jdbc.update(
...
//       jdbcTemplate.execute("Select * from header where fullName='"+mhs.getFullName()+"'");
    ...
    @Override
    public boolean isDetailExist(Details detail) {
        List<Details> datMhs = jdbc.query(
                "Select * from detail where idmhs='"+detail.getIdmhs()+"'",
                new BeanPropertyRowMapper(Details.class));
